<div class="row">
    <div class="col-12 mb-3">
        ...
        <a href="admin_report/best_month_print.php" target="_blank" class="btn btn-dark btn-icon-split">
            <span class="icon">
            ...
            <div class="card-body">
                <div class="table-responsive mt-3">
                    ...
                    $sql_best_day = " SELECT foods.id,foods.title,foods.image_name,foods.price,SUM(orders.food_qty) AS sum_qty
                            ...
                            WHERE MONTH(order_status_detail.order_status_time)='$day_nows' AND order_status_detail.order_final_status = 'อาหารของคุณเสร็จแล้ว'
                            GROUP BY foods.id
                    ...
                    <?php } else { ?>
                        <div class="alert alert-dark text-center">ไม่พบรายการขายดีประจำเดือนนี้</div>
                    <?php } ?>
                </div>
            </div>
        </div>
