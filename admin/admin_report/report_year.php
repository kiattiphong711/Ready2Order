<div class="row">
    <div class="col-12 mb-3">
        ...
        <a href="admin_report/year_print.php" target="_blank" class="btn btn-dark btn-icon-split">
            <span class="icon">
            ...
            <div class="card-body">
                <div class="table-responsive mt-3">
                    <table class="table table-striped text-center" cellspacing="0">
                        ...
                        <tbody>
                            <?php $sql_wallet_read = "SELECT DATE_FORMAT(DATE(foodtracking.status_date),'%Y') AS stat_day, 
