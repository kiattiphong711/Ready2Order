...
<body>
    ...
    <!-- Header-->
    <!-- ตัวค้นหาเริ่ม -->
    <?php $sql_cate = "SELECT * FROM category WHERE id = " . $_GET['category_id'];
    $result_cate = mysqli_query($conn, $sql_cate);
    $rs_cate = mysqli_fetch_assoc($result_cate);
    $num_cate = mysqli_num_rows($result_cate);
    $cate_name = $rs_cate['title'];
    ?>
            ...
            <div class="row gx-5 justify-content-center">
                <div class="col-lg-8">
                    <div class="text-center my-5">
                        <?php if ($num_cate) {
                            $cate_name = "รายการอาหาร " . "<span class=\"text-light\">\"$cate_name\"<span>";
                        } else {
                            $cate_name = "ไม่พบรายการอาหารนี้";
                        }
                        ?>
                        <h1 class="display-5 fw-bolder text-dark mb-2"><?= $cate_name ?></h1>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="bg-foods py-5 border-bottom">
        <div class="container px-5 my-5">
            ...
            <div class="row gx-5 justify-content-left">
                ...
                <!-- Pricing card free-->
                <?php
                $sql_foods = " SELECT * FROM foods WHERE category_id = '$_GET[category_id]' ORDER BY id ASC";
